...
class Tokenizer:
    def __init__(self):
        ...
        self.key = "12W1m925BSKlGd1TB3eqynDCv2GCy9lp".encode("utf8")
    ...
    def checkClientId(key_args):
        ...
        return client["clientId"].encode("utf8")
    ...
    def createToken(customer):
        return create_access_token(identity=Tokenizer.encrypt(customer["_id"]), fresh=True)
    ...
    def decrypt(data):
        ...
        cipher = AES.new("12W1m925BSKlGd1TB3eqynDCv2GCy9lp".encode(
            "utf8"), AES.MODE_CBC, iv=b"5w57Ey2WVcSPDGvp")
