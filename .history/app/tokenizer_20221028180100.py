...
from fastapi_jwt_auth import AuthJWT as createToken
...
class Tokenizer:
    ...
    def createToken(self, customer):
        customer = self.encrypt(customer["_id"])
        access_token = createToken.create_access_token(
            subject=customer, fresh=True, algorithm="RS256")
        return access_token
